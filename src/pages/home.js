...
const Home = (props) => {
  const { games, pcGames, consoleGames, mobileGames, allGames, allDLC, allEarly } = props;
    ...
    <>
      <div className="homePage">
        ...
        <div className="main">
          ...
          <div className="stats">
            <div>
              <small>All<br/>games</small>
              <p>{games.length}</p>
            </div>
            <div>
              <small>PC<br/>games</small>
              <p>{pcGames.length}</p>
            </div>
            <div>
              <small>Console<br/>games</small>
              <p>{consoleGames.length}</p>
            </div>
            <div>
              <small>Mobile<br/>games</small>
              <p>{mobileGames.length}</p>
            </div>
            <div>
              <small>Full<br/>games</small>
              <p>{allGames.length}</p>
            </div>
            <div>
              <small>All<br/>DLCs</small>
              <p>{allDLC.length}</p>
            </div>
            <div>
              <small>Early<br/>Access</small>
              <p>{allEarly.length}</p>
            </div>
          </div>
        </div>
